...
# آیدی‌های عددی و یوزرنیم‌های فرماندهان ارشد (Root Access)
...
# ----------------------------------------------------------
# تزریق و ساخت اتوماتیک فایل کوکی یوتیوب توسط هسته جارویس
# ----------------------------------------------------------
...
def setup_cookie_file():
    try:
        ...
        logging.info("فایل youtube_cookies.txt با موفقیت توسط جارویس بازسازی و آماده شد.")
...
# ----------------------------------------------------------
# ۵. دانلودر توربو با پشتیبانی از فایل کوکی (Cookie Bypass)
# ----------------------------------------------------------
def download_media_ultra(url):
    ...
    try:
        ...
        # موتور ثانویه جهت پشتیبانی کامل
        try:
        ...
        raise Exception("محدودیت سخت‌گیرانه یوتیوب؛ کوکی‌ها با موفقیت اعمال شدند اما دانلود با خطا روبرو شد.")
...
# ----------------------------------------------------------
# ۷. سیستم کدهای هدیه و ردیم (JARVIS GOD-MODE REDEEM ENGINE)
# ----------------------------------------------------------
